...
{
    public class TimerWin32Wrapper : IDisposable
    {
        ...
        public int Resolution
        {
            ...
            set
            {
                ...
                if (value < 0)
                    throw new ArgumentOutOfRangeException("resolution less than 0");
        ...
        public static extern uint TimeSetEvent(uint msDelay, uint msResolution, MmTimerCallback callback, ref uint user,
            uint eventType);
