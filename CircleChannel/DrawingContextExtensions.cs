...
namespace CircleChannel
{
    ...
    public static class DrawingContextExtensions
    {
        ...
        /// The radius Y.
        /// </param>
        public static void DrawArcToLeft(
            this DrawingContext dc,
            Brush brush,
            Pen pen,
            Point position,
        ...
        public static void DrawArcToRight(
            this DrawingContext dc,
            Brush brush,
            Pen pen,
            Point position,
            ...
            double radiusY)
        {
            DrawArc(dc, brush, pen, position, startAngle, endAngle, SweepDirection.Clockwise, radiusX, radiusY);
        }
    }
}